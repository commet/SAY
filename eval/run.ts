...
console.log(JSON.stringify({
  ...
  risk_precision_percent: result.metrics.riskPrecisionPercent,
  unexpected_risk_signals: result.metrics.unexpectedRiskSignals,
  low_confidence_classifications: result.metrics.lowConfidenceClassifications,
  high_confidence_misclassifications: result.metrics.highConfidenceMisclassifications,
  classification_by_type: result.metrics.classificationByType,
